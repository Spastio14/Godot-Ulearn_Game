...
/** @type {string} */
const CACHE_VERSION = '1776803206|993294002';
/** @type {string} */
const CACHE_PREFIX = 'Ulearn-sw-cache-';
const CACHE_NAME = CACHE_PREFIX + CACHE_VERSION;
/** @type {string} */
const OFFLINE_URL = 'Ulearn.offline.html';
/** @type {boolean} */
const ENSURE_CROSSORIGIN_ISOLATION_HEADERS = true;
// Files that will be cached on load.
/** @type {string[]} */
const CACHED_FILES = ["Ulearn.html","Ulearn.js","Ulearn.offline.html","Ulearn.icon.png","Ulearn.apple-touch-icon.png","Ulearn.audio.worklet.js","Ulearn.audio.position.worklet.js"];
// Files that we might not want the user to preload, and will only be cached on first load.
/** @type {string[]} */
const CACHEABLE_FILES = ["Ulearn.wasm","Ulearn.pck"];
